<template>
	<view class="page px-4">
    <uni-collapse :accordion="true">
      <uni-collapse-item class="primary--text subtitle-1" :title="item.title" v-for="(item, index) in list" :key="index">
        	<uni-collapse class="black--text" :accordion="true">
        		<uni-collapse-item class="body-2" :title="itm.title" v-for="(itm, i) in item.map" :key="i">
              <view class="px-4 py-2 grey--text">{{itm.content}}</view>
        		</uni-collapse-item>
        	</uni-collapse>
      </uni-collapse-item>
    </uni-collapse>    
